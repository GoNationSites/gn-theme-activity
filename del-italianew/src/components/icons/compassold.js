...
const compass = ({fill="#fff", width="30px"}) => {
    return (
<svg x="0px" y="0px" width={width}
	 viewBox="0 0 477.867 477.867" >
<g>
	<g>
		<path fill={fill} d="M238.933,0C106.974,0,0,106.974,0,238.933s106.974,238.933,238.933,238.933s238.933-106.974,238.933-238.933
...
<g>
	<g>
		<path fill={fill} d="M355.138,115.063c-4.793-2.388-10.428-2.388-15.221,0h0L195.106,187.46c-3.31,1.653-5.993,4.336-7.646,7.646
